                        ...
                        >
                            ...
                            >
                                ...
                                <div className="absolute -top-4 left-4 flex gap-2">
                                    ...
                                    <Motion.span animate={{ y: [0, -8, 0] }} transition={{ duration: 3, repeat: Infinity }} className="bg-white px-2 py-1 rounded-full text-xs font-semibold shadow">Laravel</Motion.span>
                                ...
                                <div className="absolute -bottom-4 right-4 flex gap-2">
                                    ...
                                    <Motion.span animate={{ x: [0, -6, 0] }} transition={{ duration: 3.4, repeat: Infinity }} className="bg-white px-2 py-1 rounded-full text-xs font-semibold shadow">Python</Motion.span>
                                </div>
                            </Motion.div>
                        </Motion.div>
                    </div>
